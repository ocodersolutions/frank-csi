...
$MailChimp = new MailChimp(fthemes_get_option('mailchimp_apikey'));

$mailchimp_result = $MailChimp->call('lists/subscribe', array(
													'id'                => fthemes_get_option('mailchimp_listid'),
...
if (isset($mailchimp_result['leid'])) {
	echo "<h4 class='icon-ok mc-response'>Thank you, a confirmation mail has been sent!</h4>";
} else {
	echo "<h4 class='nc-response'>Please try again.</h4>";
}
