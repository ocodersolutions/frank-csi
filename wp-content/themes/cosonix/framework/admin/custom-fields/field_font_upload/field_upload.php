...
class Redux_Options_font_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-font-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', 'cosonix') . '</a>';
        echo ' <a href="javascript:void(0);" class="redux-opts-font-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', 'cosonix') . '</a>';
    ...
    // gobal $wp_version; //AP: why doesn't this work?!?!
        ...
        if ( $wp_version < "3.5" ) {
            wp_enqueue_script(
                ...
                get_template_directory_uri() . '/framework/admin/field_font_upload/field_upload_3_4.js', 
            ...
            wp_enqueue_script(
                'redux-opts-field-font-upload-js', 
                get_template_directory_uri() . '/framework/admin/field_font_upload/field_upload.js', 
                array('jquery'),
                time(),
                true
            );
